...
- Firmware (different to the original two PCB design firmwire)
    - [QMK/VIAL Firmware](https://github.com/peterjc/qmk_userspace/tree/main/keyboards/tutte_coxeter_36k)
    - [ZMK Firmware](https://github.com/peterjc/tutte-coxeter-zmk-config/tree/tc36k)
...
The cost saving for no diodes is minimal, but with far less parts and soldering, this design
is quicker and easier to assemble.
